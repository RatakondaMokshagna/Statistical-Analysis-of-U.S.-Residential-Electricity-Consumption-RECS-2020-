...
```
📦 recs-electricity-analysis/
│
├── 📓 stat.ipynb                          # Main analysis notebook (Google Colab)
├── 📄 README.md                           # Project documentation (this file)
│
├── 📁 figures/                            # All visualisations generated by the notebook
│   ├── 🖼️  fig1_kwh_distribution.png      # Figure 1 — Histogram of KWH distribution
│   ├── 🖼️  fig2_regional_boxplot.png      # Figure 2 — Boxplot by census region
│   ├── 🖼️  fig3_income_vs_kwh.png         # Figure 3 — Scatter: income vs. consumption
│   └── 🖼️  fig4_residuals_vs_fitted.png   # Figure 4 — Residual diagnostic plot
│
└── 📁 data/
    └── recs2020_public_v7.csv             # RECS 2020 dataset (download separately — see below)
```

> ⚠️ **Note:** The dataset `recs2020_public_v7.csv` is **not included** in this repository due to its size. Download it directly from the [EIA RECS 2020 page](https://www.eia.gov/consumption/residential/data/2020/) and place it inside the `data/` folder before running the notebook.
